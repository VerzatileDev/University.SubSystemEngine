...
void ExecutionTimeTracker::GetAndPrintFrameRate(const std::string& subsystemName) const {
    //return frames / elapsedTime;
    std::cout << "\rFrame Rate of "<< subsystemName <<" is " << static_cast<int>(frames / elapsedTime) << " FPS " << std::endl;
}